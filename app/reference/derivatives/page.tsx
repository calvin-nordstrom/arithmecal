...
export default function DerivativesPage() {
  return (
    <CalculatorLayout>
      ...
      <ol className='formula-list' start={1}>
      ...
      <ol className='formula-list' start={9}>
      ...
      <ol className='formula-list' start={15}>
      ...
      <ol className='formula-list' start={21}>
      ...
      <ol className='formula-list' start={25}>
      ...
      <ol className='formula-list' start={31}>
